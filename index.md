...
.oc2 .prev-call-card { background: var(--grey-tint); border: 1.5px solid var(--grey-pale); border-radius: 12px; padding: 28px 32px; display: flex; align-items: center; justify-content: space-between; gap: 24px; margin-bottom: 24px; flex-wrap: wrap; }
...
.oc2 .doc-strand-label { font-size: 11px; font-weight: 700; letter-spacing: 0.10em; text-transform: uppercase; color: var(--blue); margin-bottom: 6px; }
...
.oc2 .doc-btn { display: inline-flex; align-items: center; gap: 5px; font-size: 12.5px; font-weight: 600; background: var(--blue-tint); border: 1px solid var(--blue-pale); color: var(--blue) !important; padding: 6px 12px; border-radius: 5px; text-decoration: none; transition: background 0.15s, border-color 0.15s; }
.oc2 .doc-btn:hover { background: var(--blue-pale); border-color: var(--blue-mid); }
...
<div class="oc2" style="padding-top: 40px; padding-bottom: 56px;">
  ...
  <div class="cta-grid">
    <div class="contact-card">
      <h3>Get Involved</h3>
      <p>Find consortium partners, subscribe for updates or join the stakeholder community shaping Europe's digital twin ecosystem.</p>
      <div class="cta-links">
        <a href="https://www.b2match.com/e/local-digital-twins-smart-communities" class="cta-link">🤝 Find Partners via Matchmaking Platform</a>
        <a href="https://shorturl.at/pzMGK" class="cta-link">📬 Subscribe to Newsletter</a>
        <a href="https://forms.gle/v17Y7df5DUwpCRZP6" class="cta-link">🌐 Join the Stakeholder Forum</a>
        <a href="https://ldt4ssc.eu/faq/" class="cta-link">❓ Visit Helpdesk &amp; FAQ</a>
      </div>
    </div>
    <div class="eval-card">
      <h3>Interested to apply as an evaluator?</h3>
      <p>Are you an expert in digital twins, smart cities, AI or urban planning? LDT4SSC is looking for qualified evaluators to assess Open Call 3 applications. Contribute your expertise to shape Europe's digital twin ecosystem.</p>
  ...
  <div class="sec-label">Previous Calls</div>
  <div class="prev-call-card">
    <div>
      <h4>Open Call 1 — Closed</h4>
    ...
    <a href="https://ldt4ssc.eu/call-one/" class="btn btn-outline" style="font-size:13px; padding: 9px 16px; white-space:nowrap;">View Call 1</a>
  </div>
  <div class="prev-call-card">
    <div>
      <h4>Open Call 2 — Closed</h4>
      <p>Work Strands 1, 2 and 3 — interconnecting existing Local Digital Twins, creating new ones, and adding advanced AI capabilities to the EU LDT Toolbox. Deadline was 15 April 2026.</p>
    </div>
    <a href="https://ldt4ssc.eu/call-two/" class="btn btn-outline" style="font-size:13px; padding: 9px 16px; white-space:nowrap;">View Call 2</a>
  </div>
