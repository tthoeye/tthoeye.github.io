...
<div style="max-width:1400px; margin-left:auto; margin-right:auto; padding:60px 40px; font-family:Helvetica Neue, Arial, sans-serif; color:#4C5562;">

<!-- HEADER -->
<div style="text-align:center;">
  <h1 style="color:#1F75D6; font-size:42px;">Open Call 2</h1>
...
<div style="background:rgba(31,117,214,0.08); padding:40px; border-radius:20px; margin-top:40px;">
  <p>
    ...
    invites applications for its second Open Call (Work Strands 1, 2 and 3).
  </p>
  ...
  <p><strong>Work Strand 2:</strong> Creation of new Local Digital Twins based on common needs across cities and communities.</p>
...
<div style="display:flex; flex-wrap:wrap; gap:15px; justify-content:center; margin-top:20px;">
  <div style="background:#f4f5f7; padding:16px 24px; border-radius:12px;">Up to €1,000,000 per consortium</div>
  <div style="background:#f4f5f7; padding:16px 24px; border-radius:12px;">50% co-funding required</div>
  <div style="background:#f4f5f7; padding:16px 24px; border-radius:12px;">Maximum €500,000 per third party</div>
