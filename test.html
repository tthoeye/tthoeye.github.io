...
.oc2 * { box-sizing: border-box; margin: 0; padding: 0; }
...
.oc2 .btn-blue    { background: var(--blue);   color: #fff; }
.oc2 .btn-green   { background: var(--green);  color: #fff; }
.oc2 .btn-yellow  { background: var(--yellow); color: var(--ink); }
.oc2 .btn-outline {
  background: #fff;
...
.oc2 .hero-btns { display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 36px; }
...
.oc2 .hero-diagram { width: 280px; flex-shrink: 0; }
.oc2 .hero-diagram svg { width: 100%; height: auto; display: block; }

/* ── BLOCK: coloured card sections ── */
.oc2 .block { border-radius: 14px; padding: 44px; margin-bottom: 24px; }
...
.oc2 .block-white  { background: #fff;             border: 1.5px solid var(--grey-pale); }

/* ── STRANDS INTRO GRID ── */
.oc2 .strands-grid { display: grid; grid-template-columns: repeat(3,1fr); gap: 18px; }
.oc2 .strand-intro {
  background: #fff;
...
.oc2 .strand-intro h3 { font-size: 16px; font-weight: 700; color: var(--ink); margin-bottom: 8px; }
...
.oc2 .why-body h3 { font-size: 15px; font-weight: 700; color: var(--ink); margin-bottom: 5px; }
...
.oc2 .funding-card h3 { font-size: 17px; font-weight: 700; margin-bottom: 24px; }
...
.oc2 .who-card h3 { font-size: 17px; font-weight: 700; color: var(--ink); margin-bottom: 20px; }
...
.oc2 .tl-item { position: relative; padding-top: 38px; padding-right: 20px; }
.oc2 .tl-dot {
  position: absolute;
  top: 5px; left: 0;
...
.oc2 .tl-item:nth-child(2) .tl-dot { background: var(--yellow); border-color: var(--blue-tint); }
...
.oc2 .strand-card h3 { font-size: 18px; font-weight: 700; color: var(--ink); margin-bottom: 5px; }
...
.oc2 .doc-pill:hover { border-color: var(--blue); color: var(--blue); background: var(--blue-tint); }
...
/* ── INFO SESSION ── */
.oc2 .info-inner { display: grid; grid-template-columns: 1fr 1fr; gap: 36px; align-items: start; }
.oc2 .info-left h2 { font-size: 24px; font-weight: 700; color: var(--ink); margin-bottom: 10px; }
...
.oc2 .gr-open   { color: var(--green); }
.oc2 .gr-urgent { color: #b07f00; }
...
.oc2 .contact-card h3 { font-size: 18px; font-weight: 700; color: var(--ink); margin-bottom: 8px; }
...
.oc2 .eval-card h3 { font-size: 18px; font-weight: 700; color: var(--ink); margin-bottom: 8px; }
...
@media (max-width: 800px) {
  .oc2 .hero { grid-template-columns: 1fr; padding: 32px 24px; }
  ...
  .oc2 .tl-item { padding-top: 0; padding-left: 26px; padding-bottom: 22px; }
  .oc2 .tl-dot { top: 2px; left: 0; }
  .oc2 .block { padding: 28px 22px; }
  .oc2 .strand-card { padding: 24px 20px; }
...
<div class="oc2">
  ...
  <div class="hero">
    <div>
      ...
      <h1>Build the <span class="accent">European</span> Digital Twin Network</h1>
      <p class="hero-sub">
    ...
    <div class="hero-diagram">
      <svg viewBox="0 0 280 300" xmlns="http://www.w3.org/2000/svg">
        ...
        <circle cx="46"  cy="170" r="18" fill="#EDF7E8" stroke="#29A329" stroke-width="2"/>
        <text   x="46"  y="175" text-anchor="middle" font-family="Arial" font-size="9" font-weight="700" fill="#29A329">DT</text>
        <circle cx="234" cy="170" r="18" fill="#EDF7E8" stroke="#29A329" stroke-width="2"/>
        <text   x="234" y="175" text-anchor="middle" font-family="Arial" font-size="9" font-weight="700" fill="#29A329">DT</text>
        <circle cx="108" cy="232" r="18" fill="#FFFAE8" stroke="#F5B400" stroke-width="2"/>
        <text   x="108" y="237" text-anchor="middle" font-family="Arial" font-size="9" font-weight="700" fill="#b07f00">AI</text>
        <circle cx="172" cy="232" r="18" fill="#FFFAE8" stroke="#F5B400" stroke-width="2"/>
        <text   x="172" y="237" text-anchor="middle" font-family="Arial" font-size="9" font-weight="700" fill="#b07f00">AI</text>
  ...
  <div class="strands-grid" style="margin-bottom:40px;">
  ...
  <div class="strand-card" style="margin-bottom:40px;">
    <div class="strand-header">
      <div>
  ...
  <div class="cta-grid">
    <div class="contact-card">
      ...
      <p>Reach out to the team, find partners via the matchmaking platform, join an info session or subscribe for updates.</p>
      <div class="cta-links">
