...
<title>LDT4SSC FAQ</title>
<style>
  /* Force full-width of the page */
  body, html {
    margin: 0;
    padding: 0;
    width: 100%;
...
<!-- Intro Section -->
<section class="ldt4ssc-intro full-width-section">
...
<!-- FAQ Section -->
<section class="faq-accordion full-width-section">
  <details>
    <summary>1</summary>
